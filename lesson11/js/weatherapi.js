...
if (document.getElementsByTagName('li')[1].classList.contains('active')) {
    ...
    const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=60956a22cb37b327668dedafe1faaa3b&units=imperial";
    getForecast(apiURL, forecastURL);
    ...
    const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=60956a22cb37b327668dedafe1faaa3b&units=imperial";
    getForecast(apiURL, forecastURL);
} else {
    const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.0380399&lon=-111.4048681&appid=60956a22cb37b327668dedafe1faaa3b&units=imperial";
    const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?lat=42.0380399&lon=-111.4048681&appid=60956a22cb37b327668dedafe1faaa3b&units=imperial";
    getForecast(apiURL, forecastURL);
}

function getForecast(weatherAPI, forecastAPI) {
    fetch(weatherAPI)
